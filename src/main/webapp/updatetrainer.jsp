            ...
            <h1>Add Employee</h1>          
                <div class="input">
                     <div class="inputfield">
                        ...
                        <input type="hidden" placeholder="Name" name="user_empid" value="<%=user.getEmployeeId()%>">
                    </div>
                    <div class="inputfield">
                    
                        <input type="hidden" placeholder="Name" name="user_id" value="<%=user.getId()%>">
                    </div>
                    <div class="inputfield">
                    ...
                    <div class="inputfield">
                       <i class="fa-solid fa-mobile-screen"></i>
                        <input type="text" placeholder="phone" name="user_phone" value="<%=user.getPhoneNumber()%>">
                    </div>
                    <div class="inputfield">
                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                        <input type="email" placeholder="Email" name="user_email" value="<%=user.getEmail()%>">
                    </div>
                    <div class="inputfield">
                    ...
                    <div class="inputfield">
                        ...
                        <input type="text" placeholder="status" name="user_status" value="<%=user.isStatus() %>"  >
                    </div>               
                </div>
